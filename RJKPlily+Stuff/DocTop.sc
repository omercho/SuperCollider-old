...
//w.bounds = Rect(150, 450, 150, 150)
	*makeBrowser {
		var l, t, w, h;
		browser = Window("docs",Window.screenBounds.width_(120)).front;
		browser.view.background_(Color(0, 0, 0, 0.62));
...
// server control add on
	...
	*setServer { | server |
		...
		serverView
			.states_([ 
				[name, Color.white, Color.gray(0.5, 0.5, 0.9)], 
